...
$env:VISIONAI_MIN_STABLE_SECONDS = if ($env:VISIONAI_MIN_STABLE_SECONDS) { $env:VISIONAI_MIN_STABLE_SECONDS } else { "0.45" }
...
$env:VISIONAI_UI_CAPTURE_HOLD_MS = if ($env:VISIONAI_UI_CAPTURE_HOLD_MS) { $env:VISIONAI_UI_CAPTURE_HOLD_MS } else { "300" }
