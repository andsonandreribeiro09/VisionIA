...
$env:VISIONAI_MIN_STABLE_SECONDS = if ($env:VISIONAI_MIN_STABLE_SECONDS) { $env:VISIONAI_MIN_STABLE_SECONDS } else { "0.65" }
...
$env:VISIONAI_UI_CAPTURE_HOLD_MS = if ($env:VISIONAI_UI_CAPTURE_HOLD_MS) { $env:VISIONAI_UI_CAPTURE_HOLD_MS } else { "700" }
...
$env:VISIONAI_UI_STABLE_SAMPLES = if ($env:VISIONAI_UI_STABLE_SAMPLES) { $env:VISIONAI_UI_STABLE_SAMPLES } else { "3" }
$env:VISIONAI_UI_MAX_DP_SPREAD = if ($env:VISIONAI_UI_MAX_DP_SPREAD) { $env:VISIONAI_UI_MAX_DP_SPREAD } else { "1.4" }
...
$env:VISIONAI_UI_TOTAL_CAPTURES = if ($env:VISIONAI_UI_TOTAL_CAPTURES) { $env:VISIONAI_UI_TOTAL_CAPTURES } else { "3" }
$env:VISIONAI_MIN_BATCH_CAPTURES = if ($env:VISIONAI_MIN_BATCH_CAPTURES) { $env:VISIONAI_MIN_BATCH_CAPTURES } else { "3" }
