...
def register_routes(app):
    ...
    def prontuario(id):
        ...
        if medicao:
            ...
            if medicao.get("historico_json"):
                medicao["historico"] = json.loads(medicao["historico_json"])
            else:
    ...
    def salvar_receita():
        ...
        """, (
            paciente_id,
            float(request.form["od_esf"]),
            float(request.form["od_cil"]),
            int(request.form["od_eixo"]),
            float(request.form["oe_esf"]),
            float(request.form["oe_cil"]),
            int(request.form["oe_eixo"]),
            float(request.form["adicao"])
        ))
